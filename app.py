...
st.markdown("""
Ứng dụng này cung cấp cái nhìn tổng quan về dữ liệu phim, bao gồm rating, ngân sách, doanh thu và nhiều thông tin thú vị khác.
""")
